...
//    }
    ...
    public void creates_proposal() throws Throwable {
        entrepreneursInterface.createProposal();
        VUtils.waitFor(5);
    }
    @And("^make it active$")
    public void make_it_active() throws Throwable {
        entrepreneursInterface.makeProposalStatusActive();
    ...
    public void investors_should_be_able_to_view_the_proposal() throws Throwable {

    }

    @When("^user logout as entreprenure$")
    public void user_logout_as_entreprenure() throws Throwable {
        EntrepreneursInterface.navigateToMenu();
    }
}
